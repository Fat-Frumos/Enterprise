...
<div class="modal fade" id="Mymodal">
    <div class="modal-dialog wrap">
        <div class="modal-content">
            ...
            <form class="popup" id="MyForm" action="/order" method="post">
                <label>Enter Name</label>
                <input type="text" name="name" placeholder="Enter your name" pattern="[a-zA-Z0-9]+" autocomplete="on"/><br>
                <label>Enter Password</label>
                <input type="password" name="password" placeholder="Enter your password" pattern="[a-zA-Z0-9]+" autocomplete="on"/><br>
