...
INSERT INTO public.users (id, email, name, password, active, language, role, closed) VALUES (2, 'manager@i.ua', 'manager', 'manager', false, 'en', 'manager', null);
INSERT INTO public.users (id, email, name, password, active, language, role, closed) VALUES (1, 'admin@i.ua', 'admin', 'admin', false, 'ua', 'admin', null);
...
INSERT INTO public.users (id, email, name, password, active, language, role, closed) VALUES (3962, 'neil@example.com', 'neil', 'neil', false, 'en', 'manager', null);
...
INSERT INTO public.users (id, email, name, password, active, language, role, closed) VALUES (3964, 'amelia@example.com', 'kennedy', 'amelia', null, 'en', null, null);
...
INSERT INTO public.users (id, email, name, password, active, language, role, closed) VALUES (16492, 'alice@i.ua', 'alice', 'alice', true, null, 'user', true);
